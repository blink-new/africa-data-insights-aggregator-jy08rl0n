...
import { BarChart3, Users, MessageSquare, TrendingUp, Shield } from 'lucide-react'
      ...
      <main className="py-8 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-3 max-w-2xl mx-auto mb-8 bg-white/80 backdrop-blur-sm border border-orange-200">
